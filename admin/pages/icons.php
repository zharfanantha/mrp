        ...
        <div class="container-fluid">
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Icons</h3>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">41 New Icons in 4.7</h5>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Web Application Icons</h5>
                                    <div class="icon-list row">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">File Type Icons</h5>
                                    <div class="icon-list row">
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-adjust"></i> fa-adjust</div>
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-anchor"></i> fa-anchor</div>
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-archive"></i> fa-archive</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Spinner icons</h5>
                                    <div class="alert alert-success">
                                        These icons work great with the <code>fa-spin</code> class. Check out the <a href="http://fontawesome.io/examples/#animated"
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Form Control Icons</h5>
                                    <div class="row icon-list">
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square"></i> fa-check-square</div>
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-check-square-o"></i> fa-check-square-o</div>
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-circle"></i> fa-circle</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Currency Icons</h5>
                                    <div class="row icon-list">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Text Editor Icons</h5>
                                    <div class="row icon-list">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Directional Icons</h5>
                                    <div class="row icon-list">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Video Player Icons</h5>
                                    <div class="row icon-list">
                                        <div class="col-sm-6 col-md-4 col-lg-3"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Brand Icons</h5>
                                    <div class="row icon-list">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card px-4">
                                <div class="card-block">
                                    <h5 class="card-title mb-4">Medical Icons</h5>
                                    <div class="row icon-list">
