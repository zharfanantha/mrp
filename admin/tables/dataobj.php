<?php
    include '../../connect.php';
    $data_Obj = array();
    $data = mysql_query("select id_objek, nama_objek, jarak, biaya, bencana, kategori, alamat from data_objek") or die (mysql_error());
        ...
        <div class="container-fluid">
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Data Objek Wisata Malang Raya</h3>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <a style="padding: 10px; margin-bottom: 10px" href="../form/createDataobj.php" class="btn btn-success btn-sm">Create New</a>
                            <div class="card">
                                <div class="card-block">
                                    <div class="table-responsive">
                                        <table id="tabelObj" class="table center-aligned-table">
                                            <thead>
                                            ...
                                            <tbody>
                                                <tr class="">
                                                    <?php for ($i=0; $i < sizeof($data_Obj) ; $i++) { ?>
                                                    <td><?php echo $i+1; ?></td>
                                                    <td><?php echo $data_Obj[$i]['nama_objek'] ?></td>
                                                    <td><?php echo $data_Obj[$i]['alamat'] ?></td>
                                                    <td><?php echo $data_Obj[$i]['jarak'] ?> Km</td>
                                                    <td>Rp. <?php echo $data_Obj[$i]['biaya'] ?></td>
                                                    <td><?php echo $data_Obj[$i]['bencana'] ?> Kali</td>
                                                    <td><?php echo $data_Obj[$i]['kategori'] ?></td>
                                                    <td><a href="../form/updateDataobj.php?id_objek=<?php echo $data_Obj[$i]['id_objek'] ?>" class="btn btn-primary btn-sm">Update</a></td>
                                                    <td><a href="../form/deleteDataobj.php?id_objek=<?php echo $data_Obj[$i]['id_objek'] ?>" class="btn btn-danger btn-sm">Delete</a></td> 
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
