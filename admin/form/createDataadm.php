...
<head>
    ...
    if(isset($_POST['username'])){
        ...
        $email = $_POST['email'];
        $pass = $_POST['pass'];
        $input = "INSERT INTO admin (username, email, password)
        VALUES ('".$uname."', '".$email."', '".$pass."')";
        mysql_query($input) or die (mysql_error());
        // echo $input;
        header("refresh:0; url=/rekomendasi/admin/tables/dataAdm.php");
        echo "<script type='text/javascript'>alert('Create Data Admin Berhasil !')</script>";
    }
    ?>
</head>
        ...
        <div class="container-fluid">
            <div class="row row-offcanvas row-offcanvas-right">
                ...
                <div class="content-wrapper">
                    <h3 class="text-primary mb-4">Tambah Data Admin</h3>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-block">
                                    <form class="form-horizontal" action=" " method="post">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-10">          
                                            <input type="password" class="form-control" id="pass" placeholder="Masukkan Password" name="pass" required>
                                          </div>
                                        </div>
                                        <div class="form-group">        
